...
class AppUser {
  ...
  // ── toMap (Convert object to Database format) ──
  ...
  // ── fromMap (Convert Database format to object) ──
  factory AppUser.fromMap(Map<String, dynamic> m) {
    return AppUser(
      ...
      studyGoal: m['study_goal'] as String? ?? '',
      targetGpa: (m['target_gpa'] as num?)?.toDouble() ?? 3.5,
