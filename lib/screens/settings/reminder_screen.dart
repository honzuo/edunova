...
class _ReminderScreenState extends State<ReminderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String taskTitle(int id) {
      try {
        return tasks.firstWhere((t) => t.id == id).title;
      } catch (_) {
        return 'Unknown';
      }
    }
              ...
              sliver: SliverList.separated(
                ...
                itemBuilder: (_, i) {
                  ...
                  return Dismissible(
                    ...
                    onDismissed: (_) {
                      if (r.id != null) {
                        context.read<ReminderProvider>().removeReminder(r.id!);
                      }
                    },
                    child: Card(
                      child: Padding(
  ...
  void _addReminder(BuildContext context, List tasks) {
    if (tasks.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Create a task first')),
      );
      return;
    }
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String>(
                ...
                items: ['Custom', '1 hour before', '1 day before'].map((t) {
