...
class DataExportScreen extends StatelessWidget {
  ...
  Future<void> _export(BuildContext context) async {
    ...
    buf.writeln('Title,Subject,Start,End,Duration,Notes');
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF5AC8FA).withAlpha(20),
            ...
            Text(
              'Export tasks and study sessions as CSV.',
              style: TextStyle(
                fontSize: 15,
