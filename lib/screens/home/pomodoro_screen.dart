...
class _PomodoroScreenState extends State<PomodoroScreen> {
  ...
  void initState() {
    ...
    if (widget.initialTask != null) {
      Future.microtask(() => context.read<PomodoroProvider>().linkTask(widget.initialTask));
    }
  }
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          if (_hasBg)
            Container(color: Colors.black.withAlpha(_videoCtrl != null ? 100 : 180)),
              ...
              child: Column(
                children: [
                  ...
                  _TaskSelector(
                    ...
                    onSelect: (t) => p.linkTask(t),
                    onClear: () => p.linkTask(null),
                  ),
                              ...
                              child: GestureDetector(
                                ...
                                child: AnimatedContainer(
                                  ...
                                  decoration: BoxDecoration(
                                    color: sel
                                        ? (_hasBg ? Colors.white.withAlpha(40) : cs.primary)
                                        : (_hasBg ? Colors.white.withAlpha(10) : cs.primary.withAlpha(10)),
                                    borderRadius: BorderRadius.circular(24),
                                    border: Border.all(
                                      color: sel
                                          ? (_hasBg ? Colors.white60 : cs.primary)
                                          : (_hasBg ? Colors.white24 : cs.primary.withAlpha(40)),
                                    ),
                                  ),
                                  child: Text(
                                    '$m min',
                                    style: TextStyle(
                                      ...
                                      color: sel
                                          ? Colors.white
                                          : (_hasBg ? Colors.white70 : cs.primary),
                                    ),
                                  ),
                                ),
                              ),
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              p.isRunning ? (p.linkedTask?.title ?? 'Focusing…') : '${p.selectedMinutes} min session',
                              style: TextStyle(
                                fontSize: 14,
                                color: _hasBg ? Colors.white60 : Colors.grey[500],
                  ...
                  Align(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 14,
                        fontWeight: FontWeight.w600,
                        color: _hasBg ? Colors.white70 : Colors.grey[600],
                      ),
                    ),
                  ),
                        ...
                        return Padding(
                          ...
                          child: GestureDetector(
                            ...
                            child: AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: sel
                                    ? (_hasBg ? Colors.white.withAlpha(30) : cs.primary.withAlpha(20))
                                    : (_hasBg ? Colors.white.withAlpha(8) : Colors.grey.withAlpha(15)),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                    t['icon'] as IconData,
                                    size: 16,
                                    color: sel ? (_hasBg ? Colors.white : cs.primary) : (_hasBg ? Colors.white60 : Colors.grey),
                                  ),
  ...
  // 小圆形按钮构造器
  Widget _circBtn(IconData ic, VoidCallback onTap, double sz) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          shape: BoxShape.circle,
          color: _hasBg ? Colors.white.withAlpha(15) : Colors.grey.withAlpha(30),
        ),
        child: Icon(
          ic,
          size: sz * 0.45,
          color: _hasBg ? Colors.white60 : Colors.grey[400],
        ),
      ),
    );
  }
...
// ── 独立出来的 TaskSelector 组件 ──
class _TaskSelector extends StatelessWidget {
  final bool enabled;
  final StudyTask? linkedTask;
  final void Function(StudyTask) onSelect;
  ...
  Widget build(BuildContext context) {
    ...
    // 状态 3：还没关联任务，显示选择按钮
    return GestureDetector(
      onTap: () => _showPicker(context, tasks),
      child: Card(
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              Text('Link to a task', style: TextStyle(fontSize: 14, color: Colors.grey[500])),
            ],
          ),
        ),
      ),
      ...
      builder: (ctx) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Align(
              alignment: Alignment.centerLeft,
              child: Text('Select Task', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700)),
            ),
            const SizedBox(height: 12),
            Flexible(
              child: SingleChildScrollView(
